...
\newcommand{\prim}{\vspace{5pt}\noindent\textbf{Примеры.}\vspace{-6pt}}
\newcommand{\svoy}{\vspace{5pt}\noindent\textbf{Свойства.}\vspace{-6pt}}

\newcommand{\zam}[1]{\noindent\textbf{Замечание.} #1\vspace{5pt}}

\newtheorem{theorem}{Теорема}[lec]
%\renewcommand{\thetheorem}{\arabic{theorem}}

\newtheorem{sled}{Следствие}[lec]
%\renewcommand{\thesled}{\arabic{sled}}

\newtheorem{lemm}{Лемма}[lec]
%\renewcommand{\thelemm}{\arabic{lemm}}

\newtheorem{predl}{Предложение}[lec]
%\renewcommand{\thepredl}{\arabic{predl}}
