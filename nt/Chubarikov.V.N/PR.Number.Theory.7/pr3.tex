...
\newcommand{\e}{\varphi(n)}

\begin{document}
Оцениваем сумму $\sums{n\le x}\frac1\e$. Везде $n,m\in\N, x\in\R, x\ge2, p$ простое.
$$
\e=n\prod_{p|n}\left(1-\frac1p\right)
$$
$$
\frac1\e=\frac1n\prod_{p|n}\left(1-\frac1p\right)^{-1}=\frac1n\prod_{p|n}
...
$$
Поскольку $\sums{n\le x}\frac1n<\ln x+\gamma+\frac1{2x}<\ln x+1$, то
$$
...
Следовательно,
$$
\sums{n\le x}\frac1\e<\sum_{p_1\dots p_s\le x}\frac1{(p_1-1)\dots(p_s-1)}
\frac{\ln x+1}{p_1\dots p_s}
$$
Для $p\ge3$ выполнено неравенство $p-1>\sqrt{p}$. Для $p=2$ выполнено
неравенство $p-1>\sqrt{p}/2$.
$$
\sums{n\le x}\frac1\e<\sum_{p_1\dots p_s\le x}\frac2{\sqrt{p_1}\dots\sqrt{p_s}}
\frac{\ln x+1}{p_1\dots p_s}<
(\ln x+1)\sum_{k=1}^\infty \frac2{k^{3/2}}=O(\ln x).
$$
Утверждение доказано.

\begin{note} Если использовать равенство $\sums{n\le x}\frac1n=\ln x+\gamma+O(\frac1x)$ и
аккуратно всё расписать, то с использованием тех же идей нетрудно получить асимптотическую
формулу
$$
\sums{n\le x}\frac1\e = C_1\ln x+C_2+O\left(\frac1{x^{1-\varepsilon}}\right),
$$
где $C_1,C_2$ --- абсолютные постоянные, а $\varepsilon>0$ сколь угодно мало.
$$
C_1=\sum_{\substack{s\ge0\\p_1<\dots<p_s}}\frac1{p_1\dots p_s(p_1-1)\dots(p_s-1)}=
\prod_p\left(1+\frac1{p(p-1)}\right)=1.943596\dots
$$
$$
C_2=C_1\gamma-\sum_{\substack{s\ge0\\p_1<\dots<p_s}}\frac{\ln(p_1\dots p_s)}{p_1\dots p_s
